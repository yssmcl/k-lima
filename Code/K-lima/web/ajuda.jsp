      ...
      <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper> <!-- Essa div e a de cima servem para fazer a parte do menu lateral -->
          ...
          <div class="row">
              <span><p style="color: red; font-weight: bold;">Observação: </p>Antes de importar um arquivo para o sistema,
                  lembre-se de apagar o banco de dados com o botão "Limpar banco de bados" que está presente na própria página "Atualizar Dados".
          ...
          <hr />
          <div class="row">
              <p>Para que a importação dos dados de alunos para a aplicação seja feita de forma correta, siga o modelo do
                  template disponível <a href="<%=caminho%>/img/ajuda/template_TUTORIA.xlsx">aqui</a>.
