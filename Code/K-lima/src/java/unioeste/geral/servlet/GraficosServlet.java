	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (filtroX.equals("AllCursos") || filtroX.equals("AllAnos") || filtroX.equals("AllSituacao")) {
				if (tipoFiltroBase.equals("AllCursos")) {
					valoresBase = carregaDadosNomeCurso(filtroX);//;
				} else if (tipoFiltroBase.equals("AllAnos")) {
					valoresBase = periodos;
				} else if (tipoFiltroBase.equals("AllSituacao")) {
					valoresBase = situacoes;
				...
				if (valoresBase.size() == 1) {
					...
					if (tipoFiltroY.equals("Todos os Abandonos e transferidos")) {
						...
						condicaoAND.put(tipoFiltroY, filtroAuxiliar);
					}
